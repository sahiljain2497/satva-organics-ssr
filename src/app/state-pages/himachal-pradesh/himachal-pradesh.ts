...
import pageContent from '../../../locale/state-pages/himachal-pradesh.json';
...
export class HimachalPradesh {
  ...
  private readonly b2b = getRegionB2bData('himachal-pradesh', this.locale.isHindi);
  ...
  constructor() {
    ...
    this.seo.injectJsonLd([
      ...
      breadcrumbSchema([
        ...
        { name: this.content.breadcrumbName, path: '/himachal-pradesh' },
      ]),
